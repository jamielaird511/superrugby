-- Scope paperbets_leaderboard to a competition (Super Rugby admin passes ANZ2026 competition).

drop function if exists public.paperbets_leaderboard(uuid);

create or replace function public.paperbets_leaderboard(
...
alter function public.paperbets_leaderboard(uuid, uuid) owner to postgres;
